...
import org.apache.maven.services.project.install.ProjectInstaller;
import org.apache.maven.services.project.install.ProjectInstallerRequest;
 ...
 */
@Named
class DefaultProjectInstaller extends BaseService implements ProjectInstaller
{
    ...
    @Inject
    DefaultProjectInstaller( RepositorySystem repositorySystem, ArtifactInstaller installer )
    {
        ...
        throws ArtifactInstallerException, NoFileAssignedException, IllegalArgumentException
    {
        ...
        Project project = installerRequest.getProject();
