...
public class RepositoryUtils
{
    ...
    public static Artifact toArtifact( org.apache.maven.api.artifact.Artifact artifact )
    {
        if ( artifact == null )
        {
            return null;
    ...
    public static List<RemoteRepository> toRepos( List<Repository> repos )
    {
        if ( repos == null )
        {
            return null;
    ...
    public static RemoteRepository toRepo( Repository repo )
    {
    ...
    public static String getLayout( Repository repo )
    {
        try
        {
    ...
    public static ArtifactHandler newHandler( Artifact artifact )
    {
        return new ArtifactHandler()
        {
            ...
            public boolean isIncludesDependencies() {
                return Boolean.parseBoolean( artifact.getProperty( ArtifactProperties.INCLUDES_DEPENDENCIES, "" ) );
            }
            @Override
            public String getLanguage() {
                return artifact.getProperty( ArtifactProperties.LANGUAGE, null );
            }
            @Override
            public boolean isAddedToClasspath() {
                return Boolean.parseBoolean( artifact.getProperty( ArtifactProperties.CONSTITUTES_BUILD_PATH, "" ) );
            }
        };
    }
