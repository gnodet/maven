 ...
 *
 */
class DefaultRepositoryAdapter implements Repository {
     ...
     */
    DefaultRepositoryAdapter(RemoteRepository remoteRepository )
    {
    ...
    @Override
    public String pathOfLocalRepositoryMetadata( ArtifactMetadata metadata, Repository repository )
    {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public List<Repository> getMirroredRepositories()
    {
        throw new UnsupportedOperationException();
    }

    @Override
    public void setMirroredRepositories( List<Repository> mirroredRepositories )
    {
        throw new UnsupportedOperationException();
    }
    ...
    public boolean equals( Object obj )
    {
        ...
        DefaultRepositoryAdapter other = (DefaultRepositoryAdapter) obj;
