...
import org.apache.maven.services.artifact.resolve.ArtifactResolver;
import org.apache.maven.services.artifact.resolve.ArtifactResolverException;
import org.apache.maven.services.artifact.resolve.ArtifactResolverRequest;
import org.apache.maven.services.artifact.resolve.ArtifactResolverResult;
 ...
 */
@Named
class DefaultArtifactResolver extends BaseService implements ArtifactResolver
{

    @Inject
    DefaultArtifactResolver( RepositorySystem repositorySystem )
    {
    ...
    public ArtifactResolverResult resolveArtifact( ArtifactResolverRequest request ) throws ArtifactResolverException
    {
        ...
        nonNull( request.getCoordinates(), "coordinates" );

        try
        {
            ArtifactCoordinates coordinate = request.getCoordinates();
