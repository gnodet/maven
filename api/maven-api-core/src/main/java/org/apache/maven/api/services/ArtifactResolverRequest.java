...
public interface ArtifactResolverRequest
{
    ...
    @Nonnull
    Collection<ArtifactCoordinate> getCoordinates();
    ...
    @Nonnull
    static ArtifactResolverRequest build( Session session, Collection<ArtifactCoordinate> coordinates )
    {
        return builder()
                .session( session )
    ...
    class ArtifactResolverRequestBuilder
    {
        ...
        @Nonnull
        public ArtifactResolverRequestBuilder coordinates( Collection<ArtifactCoordinate> coordinates )
        {
        ...
        {
            @Nonnull
            private final Collection<ArtifactCoordinate> coordinates;

            DefaultArtifactResolverRequest( @Nonnull Session session,
                                            @Nonnull Collection<ArtifactCoordinate> coordinates )
            {
                super( session );
            ...
            @Nonnull
            @Override
            public Collection<ArtifactCoordinate> getCoordinates()
            {
                return coordinates;
            }
        }
