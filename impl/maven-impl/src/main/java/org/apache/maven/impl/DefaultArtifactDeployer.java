...
public class DefaultArtifactDeployer implements ArtifactDeployer {
    ...
    public void deploy(@Nonnull ArtifactDeployerRequest request) {
        ...
        Collection<ProducedArtifact> t1 = request.getArtifacts();
        Collection<ProducedArtifact> artifacts = Objects.requireNonNull(t1, "request.artifacts cannot be null");
        RemoteRepository t = request.getRepository();
        RemoteRepository repository = Objects.requireNonNull(t, "request.repository cannot be null");
        try {
