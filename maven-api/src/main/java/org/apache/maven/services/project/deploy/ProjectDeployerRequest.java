package org.apache.maven.services.project.deploy;
...
public class ProjectDeployerRequest extends BaseRequest<ProjectDeployerRequest>
{
    ...
    public ProjectDeployerRequest(Session session, Project project )
    {
        setSession( session );
    ...
    /**
     * @param project the {link {@link Project project} to set
     * @return {@link ProjectDeployerRequest} for chaining.
     */
    public ProjectDeployerRequest setProject( Project project )
    {
        this.project = project;
        return this;
    }
    ...
    public ProjectDeployerRequest setRepository(Repository repository)
    {
