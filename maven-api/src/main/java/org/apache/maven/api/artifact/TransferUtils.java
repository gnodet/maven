package org.apache.maven.api.artifact;
...
public final class TransferUtils
{
     ...
     * @return {@link ArtifactCoordinates}
     */
    public static ArtifactCoordinates toArtifactCoordinate(Artifact artifact )
    {
        DefaultArtifactCoordinates coordinate = new DefaultArtifactCoordinates();
     ...
     * @return {@link ArtifactCoordinates}
     */
    public static ArtifactCoordinates toArtifactCoordinate(Extension extension )
    {
        DefaultArtifactCoordinates coordinate = new DefaultArtifactCoordinates();
     ...
     * @return {@link ArtifactCoordinates}
     */
    public static ArtifactCoordinates toArtifactCoordinate(Parent parent )
    {
        DefaultArtifactCoordinates coordinate = new DefaultArtifactCoordinates();
     ...
     * @return {@link ArtifactCoordinates}
     */
    public static ArtifactCoordinates toArtifactCoordinate(Plugin plugin )
    {
        DefaultArtifactCoordinates coordinate = new DefaultArtifactCoordinates();
     ...
     * @return {@link ArtifactCoordinates}
     */
    public static ArtifactCoordinates toArtifactCoordinate(ReportPlugin plugin )
    {
        DefaultArtifactCoordinates coordinate = new DefaultArtifactCoordinates();
